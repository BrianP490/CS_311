...
void CopyTest(llist copiedList)
{
  ...
  copiedList.addRear(6); // add 6 to the rear of the copiedList
  copiedList.displayAll(); //displays all of copiedList
  cout << "finished" << endl;
}
...
{ 
  ...
  catch(llist::OutOfRange){cout << "Error: You have tried to add a node out of range." << endl;}  // do not exit
  ...
  try {L.deleteIth(5, x); cout << "removed " << x << endl;}
  catch(llist::OutOfRange){cout << "Error: You have tried to delete a node out of range." << endl; }

  // 13. delete Ith I==0 . error (out of range)
  cout << "Step " << c << " delete 0th" <<  endl; c++;
  try {L.deleteIth(0, x); cout << "removed " << x << endl;}
  catch(llist::OutOfRange){cout << "Error: You have tried to delete a node out of range." << endl;}
  ...
  {
  L.deleteFront(x);   //calls the deleteFront funtion 
  }
  ...
  try {L.deleteFront(x);}
  catch (llist::Underflow){cerr << "Error: You have caused the linked list to overflow." << endl;}
